package me.xzelphia.geoblock.controller;

import com.google.common.collect.ImmutableSet;
import me.xzelphia.geoblock.Economy;
...
public class ClassRegistrationController {
    ...
    public void loadListeners(String packageName) {
        for (Class<?> clazz : getClassesInPackage(packageName)) {
            if (isListener(clazz)) {
                try {
                    Economy.getInstance().getServer().getPluginManager().registerEvents((Listener) clazz.newInstance(), Economy.getInstance());
    ...
    public Collection<Class<?>> getClassesInPackage(String packageName) {
        ...
        CodeSource codeSource = Economy.getInstance().getClass().getProtectionDomain().getCodeSource();
